...
var getBaoBeiJson = public_url + 'data/app/f-industry-integrated-manage/province/baobei.json';
var searchTyprArray = [];
$(function () {
    var searchType = GetUrlParamString('type');
    var selectListForProvinceFlag = 3;//获取审批事项列表参数，具体数字待定
    switch (searchType) {
        case '1':
            searchTyprArray = ['201', '202', '203', '204', '205', '206', '207', '208', '209', '212', '213', '214', '215', '216', '223', '224', '225', '226', '303', '304', '305'];
            $('.panel-title').html('已报送');
            selectListForProvinceFlag = 1;//获取审批事项列表参数，具体数字待定
            break;
        case '2':
            searchTyprArray = ['210', '302'];
