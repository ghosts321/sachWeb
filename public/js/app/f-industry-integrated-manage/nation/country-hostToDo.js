...
$(function () {
    ...
    $('#search-export').on('click', function () {
        ...
        console.log(api_ea + '/businesspplan/exportExcelList?token=' + getData('token') + '&listType=3&' + temp);
        window.open(api_ea + '/businesspplan/exportExcelList?token=' + getData('token') + '&listType=3&' + temp);
    });
})
var haveFunc = {};
haveFunc.pageNum = 1;
