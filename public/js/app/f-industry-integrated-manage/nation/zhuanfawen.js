 ...
 * @Last Modified time: 2018-07-13 11:46:45
 */
var _projectNum = '';
var _applyId = '';
var _status = '';
                    ...
                    if (!IsNull(prevModelData) && prevModelData.state == '200') {
                        ...
                        $('#filelist-P0907.file-upload-list li').each(function (index) {
                            ...
                            $(this).on('click', function () {
                                window.open('/app/f-industry-integrated-manage/applyinfo.html?from=undefied&status=' + cmx.g.relatedFile.values()[index].oldStatus + '&applyId=' + cmx.g.relatedFile.values()[index].oldApplyId + '&projectNum=' + cmx.g.relatedFile.values()[index].oldProjectNum + '&nowid=' + GetUrlParamString('nowid'));
                            });
                        })
                    }
                })
        ...
        switch (_type) {
            case '1': //处长处员处理中
                ...
                $('#cmx-zhuanjia').on('click', function () {
                    ...
                    location.href = '/app/f-industry-integrated-manage/nation/zhuanjiajigou.html?' + paramStr;
                });
                break;
            case '2': //司领导处理中
                $('#cmx-save').css('display', 'inline-block');
...
$(document).ready(function () {
    ...
    $('#cmx-original-receipt').on('click', function () {
        ...
        window.open('/app/f-industry-integrated-manage/applyinfo.html?frompage=zhuanfawen&from=undefined&' + paramStr + '&nowid=' + GetUrlParamString('nowid'));
    });
    //批量打印
