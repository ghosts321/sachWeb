...
$(function () {
    ...
    switch (searchType) {
        case '1':
            searchTyprArray = ['212', '201', '202', '203', '204', '205', '206', '207', '208', '209', '213', '214', '215', '216', '223', '224', '225', '226', '227', '301', '302', '303', '304', '305'];
            $('.panel-title').html('已办');
            break;
        case '2':
            searchTyprArray = ['210'];
    ...
    $('#search-export').on('click', function () {
        ...
        window.open(api_ea + '/businesspplan/exportExcelList?token=' + getData('token') + '&listType=' + (GetUrlParamString('type') == '1' ? '2' : '5') + '&' + temp);
    });
})
