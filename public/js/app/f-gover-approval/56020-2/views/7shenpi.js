cmx.route.view({
    ...
    resolve: function (param) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            '<button func-id="0101030102060100" data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-shenpi">审批</button><button func-id="0101030102060200" data-id="' + applyId + '"  style="margin:5px;" class="btn btn-primary btn-xs exit-application-print" ' + isApprove + '>打印</button>',
            '<button func-id="0101030102060300" data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-accept" ' + isApprove + '>办结</button><button func-id="0101030102060400" data-id="' + applyId + '"  style="margin:5px;" class="btn btn-primary btn-xs cmx-refuse">退回</button>',
    ...
    resolve: function (param) {
        ...
        if (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                if (apprStatus == '2') {
                    var regStatusText = '<button func-id="0101030102060500" class="btn btn-xs btn-primary btn-info editRelic" style="margin:0 5px;" data-id="' + relicId + '">审批</button>';
                    var active = '';
                } else {
                    var regStatusText = '<button func-id="0101030102060500" class="btn btn-xs btn-primary btn-info editRelic" style="margin:0 5px;" disabled data-id="' + relicId + '">已审批</button>';
                    var active = ' active';
                };
                ...
                $("#relicTotal").text('共' + param.data.total + '条')
