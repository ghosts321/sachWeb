...
cmx.route.model({
    ...
    handle: function (parameter, prevModelData, send, abort) {
        ...
        if (param.state == '200') {
            ...
            setTimeout(function () {
                window.location.href = public_url + 'app/f-gover-approval/56020-2/6jianding.html?nowid=' + GetUrlParamString('nowid');
            }, 1000)
        } else {
            showAlert({
                type: 'error',
    ...
    handle: function (parameter, prevModelData, send, abort) {
        ...
        if (param > 0) {
            showAlert({
                ...
                content: '还有' + param + '个文物尚未查验，是否一键查验并提交？',
        ...
        $(".editRelic").click(function () {
            ...
            $("#cmx-relic-modal").load(editRelicInfoModal, function () {
                ...
                $('#cmx-editrelicinfo').on('shown.bs.modal', function () {
                    ...
                    $('[cmx-index="cmx-30-IsAllow"]').parent().css('visibility', 'hidden');
