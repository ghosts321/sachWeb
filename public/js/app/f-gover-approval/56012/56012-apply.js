var _projectType = '2';
var _projectNum = '56012';

var get56012ProjectData = public_url + 'data/app/f-gover-approval/56012/56012-apply.json';
...
function cmx_special_2(data) {
    var html = [
        ...
        '" value=""></div>',
        '<div class="col-sm-3 col-md-3 col-xs-3"><button class="cmx-noNationProject-choose btn btn-primary">选择</button></div>',
    ].join("");
