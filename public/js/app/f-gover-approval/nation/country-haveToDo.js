...
var searchTyprArray = [];
$(function () {
    // searchTyprArray = ['901', '103', '104', '105', '106', '107', '108', '109', '207', '230', '231', '232', '250', '201', '202', '203', '204', '205', '206', '207', '208', '209', '213', '214', '215', '216', '223', '224', '225', '226', '227', '301', '302', '303', '304', '305', '401', '993', '994', '887', '886', '867', '868', '990', '992', '880', '882', '881', '991', '701', '481', '482', '883', '884', '873', '872', '980', '982', '981', '702', '493', '494', '874', '876', '864', '866', '980', '982', '497', '498', '877', '878', '495', '496', '987', '499', '773', '776', '777'];
    ...
    $('#search-export').on('click', function () {
        ...
        window.open(api_ea + '/business/exportExcelList?token=' + getData('token') + '&listType=2&' + temp);
    });
    //排序初始化
    cmxTableSort({
        callback: function () {
