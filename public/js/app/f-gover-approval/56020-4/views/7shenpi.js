cmx.route.view({
    ...
    resolve: function (param) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            '<button func-id="0101030103060100" data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-shenpi">审批</button><button func-id="0101030103060200" data-id="' + applyId + '"  style="margin:5px;" class="btn btn-primary btn-xs exit-application-print" '+isApprove+'>打印</button>',
                '<button func-id="0101030103060300" data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-accept" '+isApprove+'>办结</button><button func-id="0101030103060400" data-id="' + applyId + '"  style="margin:5px;" class="btn btn-primary btn-xs cmx-refuse">退回</button>',
