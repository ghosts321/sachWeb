...
if (getData('role') == 'guobaodanwei') {
    var get56014cNoNationProjectFormData = public_url + 'data/app/f-gover-approval/56014/56014-c-x.json';

} else {
    var get56014cNoNationProjectFormData = public_url + 'data/app/f-gover-approval/56014/56014-c-s.json';

}
var _projectType = '2';
var _projectNum = '56014_c';
$(document).ready(function () {
            ...
            .turn(function (prevModelData, send, abort) {
                if (prevModelData.state == '200') {
                    if (prevModelData.data.accClass == '15') {
                        get56014cNoNationProjectFormData = public_url + 'data/app/f-gover-approval/56014/56014-c-x.json';
                    }
                    else {
                        get56014cNoNationProjectFormData = public_url + 'data/app/f-gover-approval/56014/56014-c-s.json';
                    }
                } else {
                    showAlert({
                        type: 'error',
    ...
    CreateApplicationForm({
        "url": get56014cNoNationProjectFormData,
        "element": "#cmx-form"
    });
    $(".cmx-textarea").hide();
    $('#cmx-menu')
    ...
    $("#cmx-noNationProject-save").on("click", function () {
        ...
        var data = [{
            ...
            // networkNum: "网审1号",
            // processDefinitionId: "BusinessProcess:1:fa56b0e90f3440c98f72b409b22a9351",
            // processInstanceId: "6ed3f585f11d432183c0c3defae9ee55",
...
// //以下是取值用的
// var buildFormData = [{ 
// 	projectNum: "56014_a", //审批事项 类型：String  必有字段  备注：无 
// 	/**
// 	*	修改的
// 	*/
// 	fileNumFront: $("#cmx-i-4-1").val(), //省文件号前---
...
//以下是赋值用的
// $("#cmx-i-4-1").val(data.fileNumFront); //省文件号前---
// $("#cmx-i-4-2").val(data.fileNumMidd); //省文件号中---
// $("#cmx-i-4-3").val(data.fileNumBack); //省文件号后---
// $("#cmx-i-5").val(data.proFileTitle); //省文件标题
// $("#cmx-i-6").val(data.contactName); //联系人
// $("#cmx-i-7").val(data.contactTel); //联系电话
// $("#cmx-i-9").val(data.protectUnit); //国保单位
// $('#cmx-i-10 input[value="'+ data.protectWorkType +'"').attr("checked",true); //保护工程类型
// $("#cmx-i-11").val(data.projectName); //项目名称
// $("#cmx-i-12").val(data.designUnits); //设计单位
// $("#cmx-i-13").val(data.proFunds); //工程概算
// $("#cmx-i-14").val(data.otherExplain); //其他说明事项
// $("#cmx-i-26").val(data.proIntroduce); //项目介绍
// $("#cmx-i-27").val(data.desTask); //设计任务---
