    ...
    resolve: function (param) {
        ...
        if (data.length > 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                '<button func-id="0101030102101000" data-instid="' + instid + '"  data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-accept">分办</button><button func-id="0101030102101100" data-id="' + applyId + '" class="btn btn-primary btn-xs cmx-refuse">退回</button>',
