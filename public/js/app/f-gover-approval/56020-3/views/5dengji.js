    ...
    resolve: function (param) {
        ...
        if (data.length > 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                '<button func-id="0102401400000000"  data-type="' + applyClassName + '" class="btn btn-info btn-xs exit-application-update" data-id="' + applyId + '">修改</button><button func-id="0101030102110200" data-id="' + applyId + '" style="margin:5px;" class="btn btn-primary btn-xs cmx-accept">提交</button><button func-id="0101030102110300" data-id="' + applyId + '"  style="margin:5px;" class="btn btn-primary btn-xs cmx-refuse">退回</button>',
...
cmx.route.view({
    ...
    resolve: function (param) {
        ...
        $("#cmx-1-IDCardType1").val(data.idcardType);
...
cmx.route.view({
    ...
    resolve: function (param) {
        ...
        getApplyList(3, '/eaScrApplyInfo/getCurrenList', 5);
    },
    reject: function (data) {
        showAlert({
            type: 'error',
...
cmx.route.view({
    ...
    resolve: function (param) {
        ...
        $("#relicList").empty();
        if (data) {
            relicListDengji(data,pageInfo,3);
        } else {
            $("#relicTotal").text('共0条')
        }
