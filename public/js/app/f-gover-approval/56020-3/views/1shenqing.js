    ...
    resolve: function (param) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            switch (acceptId) {
                case '1':
                    button =
                        ...
                        '<button func-id="0102380300000000"  class="btn btn-info btn-xs exit-application-update" data-id="' + applyId + '" data-type="' + applyClassName + '">修改</button>';
                    break;
                case '2':
                    button =
            ...
            html = ['<tr style="color:' + font_color + '" data-color="' + font_color + '"  class="exitList" data-id="' + applyId + '" data-applyStatus="' + acceptId + '">',
                ...
                '<td>' + state + '</td>',
                '<td ' + font_color + '>' + applyClassName + '</td>',
                '<td>' + AcceptNum + '</td>',
                '</tr>',
...
cmx.route.view({
    ...
    resolve: function (param) {
        ...
        getApplyList(3, '/eaScrApplyInfo/getApplyList', 1);
    },
    reject: function (data) {
        showAlert({
            type: 'error',
...
cmx.route.view({
    ...
    resolve: function (param) {
        ...
        $("#relicList").empty();
        if (data) {
            relicListShenqing(data, pageInfo, applyStatus, 3);
            //设置pageSize
