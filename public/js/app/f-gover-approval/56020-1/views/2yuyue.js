    ...
    resolve: function (param) {
        ...
        if (data.length > 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                '<button func-id="0101030101010100" data-id="' + applyId + '" style="margin-right:5px;" class="btn btn-primary btn-xs cmx-accept">接受预约</button><button func-id="0101030101010200" data-id="' + applyId + '" class="btn btn-primary btn-xs cmx-noAccept">不接受预约</button>',
