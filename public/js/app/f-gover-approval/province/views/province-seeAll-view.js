...
cmx.g.ProvincestatusStr.put('230', '国家局处理中'); //同210也是办结状态，只是结果为不同意发掘
cmx.g.ProvincestatusStr.put('231', '国家局处理中'); //同210也是办结状态，只是结果为不同意发掘
cmx.g.ProvincestatusStr.put('232', '国家局处理中');
cmx.g.ProvincestatusStr.put('250', '国家局处理中'); //同210也是办结状态，只是结果为不同意发掘
cmx.g.ProvincestatusStr.put('901', '申请人已撤销');//属于已办
cmx.g.ProvincestatusStr.put('902', '管理员办结');//属于办结
