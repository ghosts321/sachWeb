var get56019yijianData = public_url + 'data/app/f-gover-approval/inspection/56019.json';
cmx.g.regist('examId', '');
$(document).ready(function () {
    ...
    $("#cmx-button-save").on("click", function () {
        ...
        var ss = [{ //类型：Object  必有字段  备注：无
            ...
            expertOpinion: $("#cmx-i-5").val() //评审意见
        }];
        console.log(ss);
        new cmx.process()
            .turn('callajax', {
    ...
    handle: function (parameter, prevModelData, send, abort) {
        ...
        if (!IsNull(prevModelData) && prevModelData.state == '200' && !IsEmpty(prevModelData.data) && prevModelData.data != 'null') {
            ...
            $("#cmx-i-2").val(data.item1),
                ...
                $("#cmx-i-6").val(data.item3),
                $("#cmx-i-7").val(data.item4),
