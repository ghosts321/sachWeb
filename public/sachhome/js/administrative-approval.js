$(function(){
    ...
    // 封装一下
    function ajaxInfo(pagenum, pagesize, column, keyword, postdate) {
        $.ajax({
    ...
    $('#retrieve').on('click', function (e) {
        ...
        ajaxInfo(1, 20, '0700000000', keyword, postdate);
        $.ajax({
            data: { column: '0700000000', pagenum: 1, pagesize: 20, keyword: keyword, postdate: postdate },
            success: function (res) {
                ...
                if (res.data.dataList.length) {
                    ...
                    $('.M-box4').pagination({
                        ...
                        callback: function (api) {
                            ...
                            ajaxInfo(pagenum, 20, '0700000000', keyword, postdate);
                        }
                    });
                } else {
                    // $('#sheet-tbody').html(msg.noData); // 没有数据显示暂无数据
