    ...
    function Alertify() {
        ...
        var _alertify = {
            ...
            theme: function(themeStr) {
                switch(themeStr.toLowerCase()) {
                    case "bootstrap":
                        this.dialogs.buttons.ok = "<button class='ok btn btn-default' tabindex='1'>{{ok}}</button>";
                        this.dialogs.buttons.cancel = "<button class='cancel btn btn-primary' tabindex='2'>{{cancel}}</button>";
        ...
        return {
            ...
            info: function(message, click) {
                _alertify.log(message, "info", click);
                return this;
            },
