...
var notie = function(){
    ...
    // notie.alert colors
    var alert_color_success_background = '#00c292';
    var alert_color_warning_background = '#fec107';
    var alert_color_error_background = '#fb9678';
    var alert_color_info_background = '#03a9f3';
    var alert_color_text = '#FFF';

    // notie.confirm colors
    var confirm_and_input_color_background = '#03a9f3';
    var confirm_and_input_color_yes_background = '#00c292';
    var confirm_and_input_color_no_background = '#efefef';
    var confirm_and_input_color_text = '#FFF';
    var confirm_and_input_color_yes_text = '#FFF';
    var confirm_and_input_color_no_text = '#000';
    ...
    function confirm_show(title, yes_text, no_text, confirm_callback) {
    ...
    function input(title, submit_text, cancel_text, type, placeholder,the_value, submit_callback,auto_close, prefilled_value_optional) {
        alert(auto_close);
        // Blur active element for use of enter key, focus input
        document.activeElement.blur();
        ...
        if (alert_is_showing) {
            ...
            clearTimeout(alert_timeout_2);
            alert_hide(function() {
                input_show(title, submit_text, cancel_text, submit_callback,auto_close);
            });
        }
        else {
            input_show(title, submit_text, cancel_text, submit_callback,auto_close);
    ...
    function input_show(title, submit_text, cancel_text, submit_callback,auto_close) {
        ...
        input_yes.onclick = function() {
			if(auto_close!==false)
				input_hide();
            setTimeout(function() {
                submit_callback('yes',input_field.value);
            }, (animation_delay * 1000 + 10));
        }
		...
		input_no.onclick = function() {
				input_hide();
            setTimeout(function() {
                submit_callback('no',input_field.value);
            }, (animation_delay * 1000 + 10));
        }
		input_background.onclick = function() {
            input_hide();
            setTimeout(function() {
                submit_callback('cancel',input_field.value);
            }, (animation_delay * 1000 + 10));
        }
